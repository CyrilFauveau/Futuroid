...
<main class="block-main">
  <div class="banniere banniere-entreprise">
    <h2>ENTREPRISE</h2>
    <p class="resume-title">Privatisez le centre complet pour votre entreprise</p>
  </div>
  ...
  <div class="wrapper">
    ...
    <h3 class="h3-title">Privatisation du centre de réalité virtuelle</h3>
    <p class="resume-entreprise">Intégrer de nouveaux collaborateurs / Fêter un nouveau contrat / Entretenir l'esprit d'équipe
